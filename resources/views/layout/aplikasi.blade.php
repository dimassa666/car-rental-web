...
<body>
    ...
    <div class="container-chat">
        <button id="toggleChat" class="toggle-chat"><img src="{{ asset('img/technical-support.png') }}" alt="Chat icon"
                width="30" height="30"> LIVE</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function appendMessage(sender, message) {
                ...
                <img class="avatar" src="https://ps.w.org/user-avatar-reloaded/assets/icon-256x256.png?rev=2540745" alt="User Avatar">
              `;
                } else {
                    messageDiv.innerHTML = `
                <img class="avatar" src="{{ asset('img/technical-support.png') }}" alt="Bot Avatar">
