...
<section class="ftco-section ftco-about">
    ...
    <section class="ftco-section ftco-intro" style="background-image: url(main/images/bg_3.jpg);">
        <div class="overlay"></div>
        <div class="container">
  ...
  <div class="container">
    ...
    <div class="row d-flex">
      <div class="col-md-4 d-flex ftco-animate">
          ...
          <a href="blog-single.html" class="block-20" style="background-image: url('main/images/image_1.jpg');">
          </a>
          <div class="text pt-4">
              <div class="meta mb-3">
      ...
      <div class="col-md-4 d-flex ftco-animate">
          <div class="blog-entry justify-content-end">
          <a href="blog-single.html" class="block-20" style="background-image: url('main/images/image_2.jpg');">
          </a>
          <div class="text pt-4">
              <div class="meta mb-3">
              <div><a href="#">Oct. 29, 2019</a></div>
      ...
      <div class="col-md-4 d-flex ftco-animate">
          ...
          <a href="blog-single.html" class="block-20" style="background-image: url('main/images/image_3.jpg');">
          </a>
          <div class="text pt-4">
              <div class="meta mb-3">
              <div><a href="#">Oct. 29, 2019</a></div>
